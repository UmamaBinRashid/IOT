...
void loop()
{
  ...
  client.println("<h1>GROUP MEMBERS:</h1>");
  client.println("<h1>UMAMA BIN RASHID</h1>");
  client.println("<h1>ATIF BAIG</h1>");
  client.println("<h1>ABDUL SAMAD</h1>");
